...
#define ROUTER_SEL 4/* Starts with 0 */
#define STARTNODE 2/* Starts with 1 */
#define ENDNODE 5/* Starts with 1 */
...
struct router
{
    int dist[10000];//int dist[N]; MANI
	int from[10000];//int from[N]; MANI
}rt[10000];//rt[N];MANI


int bpcost[10000];//int bpcost[N]; MANI

struct bkupcur
{
	int index;
	int cost[10000];//int cost[N];MANI
}bpcur[10000];//bpcur[N];MANI
int bpcurIndex=-1;
